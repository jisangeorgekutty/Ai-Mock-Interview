...
export default function Page() {
  ...
  const { userLogIn, isLoggingIn, authUser, checkAuth } = useAuthStore();
      ...
      <div className="flex flex-col items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="btn bg-white-500 hover:bg-gray-400 rounded-2xl  text-black w-full mt-6 flex items-center justify-center gap-2"
          ...
          <div className="text-center">
            <p className="text-base-content opacity-60">
              ...
              <Link href="/sign-up" className='link text-blue-800 hover:bg-blue-200 rounded underline '>Create account</Link>
            </p>
          </div>
        </div>
      </div>
